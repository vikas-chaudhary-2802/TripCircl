...
/**
 * Port of supabase/functions/generate-itinerary/prompts.ts to CommonJS.
 * All logic is identical — only module syntax changed.
 */

function getStyleInstructions(travelStyle, totalBudget, numTravelers, currencySymbol, days) {
...
module.exports = { getStyleInstructions, buildSystemPrompt, buildUserPrompt };
